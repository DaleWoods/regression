...
| A2  | ~~**Git for Windows**~~ ALREADY INSTALLED | 2.55.0.3 (confirmed 22/07/2026) | Source control. **No action needed — already present on the QA machine.**                                                                                                        | https://git-scm.com/download/win                  |
